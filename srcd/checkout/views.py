...
def checkout_redirect_view(request):
    ...
    print(checkout_subscription_price_id)
    try:
    ...
    cancel_url_path = reverse('stripe-checkout-end')
...
def checkout_finalize_view(request):
    ...
    if None in [sub_obj,_user_sub_obj,user_obj]:
        return HttpResponseBadRequest("There was an error with you account please contact support")
    if _user_sub_exist:
